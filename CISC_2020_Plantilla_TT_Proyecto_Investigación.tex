		...
		\begin{center}
			{\renewcommand{\arraystretch}{2}		
				...
				\begin{tabular}{|p{1.5cm} l|l|}  
					...
					\multicolumn{1}{|p{7cm}|}{\textbf{AUTOR(ES):}\newline BRYAN JOSE ARIAS MARTINEZ \newline
						BRYAN STEVEN ZAMORA LITARDO}  & \multicolumn{2}{p{5.5cm}|}{\textbf{\footnotesize REVISOR(A)} \newline GARY REYES ZAMBRANO}\\ 
					\hline
					...
					\hline
					\multicolumn{3}{|l|}{\textbf{\footnotesize ÁREA TEMÁTICA:} \textit{TECNOLOGIA DE LA INFORMACION Y TELECOMUNICACIONES}}\\
					\hline
		...
		\begin{flushright}
			\begin{minipage}[b]{10cm}
				...
				\hspace*{1.2cm}\textbf{Autor(a):} BRYAN STEVEN ZAMORA LITARDO \\
					\hspace*{6.5cm}{\textbf{C.I. N$^{0}$ }0928914464}\\
